...
class CheckInOutWizard extends React.Component {
  constructor(props) {
    super(props);
    var width;
...
export default withStyles(wizardStyle)(CheckInOutWizard);
